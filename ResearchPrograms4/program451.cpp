#include<iostream> //Singly Linear Linked List Of Double.
using namespace std;
...
int main()
{
    ...
    obj.InsertFirst(524.6364);
    obj.InsertFirst(25.24);
    obj.InsertFirst(2.8574);

    obj.Display();
    iRet = obj.Count();
    cout<<"Number of elemensts are : "<<iRet<<endl;

    obj.InsertLast(42.6554);
    obj.InsertLast(58.246);
    obj.InsertLast(235.54);
    
    obj.Display();
    iRet = obj.Count();
    cout<<"Number of elemensts are : "<<iRet<<endl;

    obj.InsertAtPos(25.4154,5);
    obj.Display();
    iRet = obj.Count();
    cout<<"Number of elemensts are : "<<iRet<<endl;
